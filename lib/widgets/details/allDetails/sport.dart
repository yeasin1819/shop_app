...
class _SportDetailsPageState extends State<SportDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    Iterable<Sport> _product = Provider.of<SportProvider>(context)
        .products
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: Image(
                  fit: BoxFit.cover,
                  image: AssetImage(_product.first.image.toString())),
            ),
            actions: [
              TextButton(
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        padding: EdgeInsets.only(left: 12.0),
                        child: Text(_product.first.name.toString()),
                      ),
                      Container(
                        padding: EdgeInsets.only(left: 12.0),
                        child: Row(
                            ...
                            Container(
                              child: Row(
                                children: [
                                  ...
                                  Text(
                                    'category : ${_product.first.gametype}',
                                  )
                                ],
                              ),
                            ),
                            Container(
                              child: Row(
                                children: [
                                  ...
                                  Text(
                                      'sub - category : ${_product.first.gametype}')
                                ],
                              ),
                            ),
                            // Container(
