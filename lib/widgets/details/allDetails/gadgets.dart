...
class GadgetsDetailsPage extends StatefulWidget {
  const GadgetsDetailsPage({Key? key}) : super(key: key);

  @override
  State<GadgetsDetailsPage> createState() => _GadgetsDetailsPageState();
}

class _GadgetsDetailsPageState extends State<GadgetsDetailsPage> {
  @override
  Widget build(BuildContext context) {
    final arg = ModalRoute.of(context)!.settings.arguments as ProductId;

    Iterable<Gadgets> _product = Provider.of<GadgetsProvider>(context)
        .products
