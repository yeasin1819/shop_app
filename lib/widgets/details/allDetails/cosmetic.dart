...
class CosmeticDetailsPage extends StatefulWidget {
  const CosmeticDetailsPage({Key? key}) : super(key: key);

  @override
  State<CosmeticDetailsPage> createState() => _CosmeticDetailsPageState();
}

class _CosmeticDetailsPageState extends State<CosmeticDetailsPage> {
  @override
  Widget build(BuildContext context) {
    final arg = ModalRoute.of(context)!.settings.arguments as ProductId;

    Iterable<Cosmetic> _product = Provider.of<CosmeticProvider>(context)
        .products
