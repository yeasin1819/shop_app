...
class FirnitureDetailsPage extends StatefulWidget {
  const FirnitureDetailsPage({Key? key}) : super(key: key);

  @override
  State<FirnitureDetailsPage> createState() => _FirnitureDetailsPageState();
}

class _FirnitureDetailsPageState extends State<FirnitureDetailsPage> {
  @override
  Widget build(BuildContext context) {
    final arg = ModalRoute.of(context)!.settings.arguments as ProductId;

    Iterable<Firniture> _product = Provider.of<FirnitureProvider>(context)
        .products
          ...
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: CachedNetworkImage(
                imageUrl: _product.first.imageUrl,
                fit: BoxFit.cover,
