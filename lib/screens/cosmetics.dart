...
import 'package:shop_app/screens/sliver/cosmetic.dart';
...
class CosmeycisHomePage extends StatefulWidget {
  const CosmeycisHomePage({Key? key}) : super(key: key);

  @override
  State<CosmeycisHomePage> createState() => _CosmeycisHomePageState();
}

class _CosmeycisHomePageState extends State<CosmeycisHomePage> {
  String? getvalue;
