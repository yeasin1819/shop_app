...
import 'package:shop_app/widgets/productCart/gadgets.dart';

class GadgetsSliverProduct extends StatelessWidget {
  final List? productList;
  const GadgetsSliverProduct({Key? key, this.productList}) : super(key: key);
    ...
    return productList == null
        ...
        : SliverGrid(
            delegate: SliverChildBuilderDelegate(
                (context, index) => GadgetsProductCard(
