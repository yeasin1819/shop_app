...
import 'package:shop_app/widgets/productCart/food.dart';

class FoodSliverProduct extends StatelessWidget {
  final List? productList;
  const FoodSliverProduct({Key? key, this.productList}) : super(key: key);
