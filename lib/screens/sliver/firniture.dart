...
import 'package:shop_app/widgets/productCart/firniture.dart';

class FirnitureSliverProduct extends StatelessWidget {
  final List? productList;
  const FirnitureSliverProduct({Key? key, this.productList}) : super(key: key);
    ...
    return productList == null
        ...
        : SliverGrid(
            delegate: SliverChildBuilderDelegate(
                (context, index) => FirnitureProductCard(
