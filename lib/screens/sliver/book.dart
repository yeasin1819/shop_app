...
import 'package:shop_app/widgets/productCart/book.dart';

class BookSliverProduct extends StatelessWidget {
  final List? productList;
  const BookSliverProduct({Key? key, this.productList}) : super(key: key);
