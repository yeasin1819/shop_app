...
import 'package:shop_app/widgets/productCart/cosmetic.dart';

class CosmeticSliverProduct extends StatelessWidget {
  final List? productList;
  const CosmeticSliverProduct({Key? key, this.productList}) : super(key: key);
    ...
    return productList == null
        ...
        : SliverGrid(
            delegate: SliverChildBuilderDelegate(
                (context, index) => CosmeticProductCard(
